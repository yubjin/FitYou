...
public class JWTAuthorizationFilter extends OncePerRequestFilter {
	...
	response, FilterChain filterChain) throws IOException, ServletException {
		...
		Optional<Member> opt = memberRepository.findByUsername(username); // 토큰에서 얻은 username으로 DB를 검색해서 사용자를 검색
		...
		User user = new User(findmember.getUsername(), findmember.getPwd(),
